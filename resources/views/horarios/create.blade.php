...
@section('seccion','Horarios')
@section('encabezado','Listado de Horarios')
@section('link'){{url('horarios/create')}}@endsection
@section('link2','Disponibilidad Horaria')
@section('seccion2','Disponibilidad Horaria')
@section('content')

    <form action="{{url('/horarios/'.$doctor->id.'/guardar')}}" method="POST">
        @csrf
        <input type="text" name="doctor_id" hidden>

        <div class="row align-items-center">
            <div class="col"><h2 class="text-center"> DISPONIBILIDAD HORARIA: {{$doctor->nombres}} {{$doctor->apellidoPaterno}}</h2></div>
            <div class="col">
