...
Route::post('{doctor}/{fecha}/{inicio}/show', [\App\Http\Controllers\CitaController::class,'hora']);
Route::post('{doctor}/{fecha}/{inicio}/buscarPaciente', [\App\Http\Controllers\CitaController::class,'buscarPaciente']);
Route::post('/citas/{doctor}/{fecha}/{inicio}/{paciente}/crear', [\App\Http\Controllers\CitaController::class,'confirmaHora']);
